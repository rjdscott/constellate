...
|---|---|---|---|---|---|
| Lyra | 0 (in-process) | n/a | 348MB on disk | n/a | n/a |
...
| `--telemetry-enabled=false`, `--log-level=WARNING` | n/a | no phone-home during a measured run; log noise off the critical path |
