...
Point-in-time audits of a surface (code, security, UX, data coverage).
Created via the `/audit` skill.

## Conventions

- One audit = one dated directory: `<YYYY-MM-DD>-<slug>/` containing
  `00-executive-summary.md`, `NN-topic.md` finding docs, and a `todo.md`
